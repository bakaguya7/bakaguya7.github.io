...
<main id="main" class="main">
    ...
    @endif -->
                <div class="d-flex align-items-center justify-content-between mb-3">
                    <h3>Register Guru</h3>
                    <a href="/register-guru-create" class="btn btn-primary">
                    ...
                    <tbody>
                        @if($RegisGuru->count() > 0)
                            ...
                            <tr>
                                ...
                                <td class="d-flex">
                                    <a href="{{ route('register-guru.edit', $guru->id) }}" class="btn"><img src="img/icon/pen-fill.svg" class="svg-custom svg1"
                                            alt=""></a>
