...
<main id="main" class="main">
    ...
    @endif -->
                <div class="d-flex align-items-center justify-content-between mb-3">
                    ...
                    <a href="/school-program-create" class="btn">
                            ...
                            <tr>
                                ...
                                <td class="px-0 py-0">
                                    <div class="d-flex justify-content-center">
                                        <a href="{{ route('school-program.edit', $program->id) }}" class="btn">
                                            <i class="bi bi-pen-fill svg1" style="font-size: 1.3rem;"></i>
                                        </a>
                                        <form action="{{ route('school-program.destroy', $program->id) }}" class="" method="POST" type="button" onsubmit="return confirm('Delete?'">
                                            @csrf
                                            @method('DELETE')
