      ...
      <nav id="nav" class="nav ">
        <div class="collapse navbar-collapse">
          <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <li class="nav-item">
              <a class="click nav-link collapsed" href="#jurusan">JURUSAN</a>
            </li>
            <li class="nav-item dropdown">
              <a class="click nav-link dropdown-toggle" href="#program" id="navbarDropdownMenuLink" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                PROGRAM SEKOLAH
              </a>
              <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                <li><a class="dropdown-item" href="#pembangunan">- Pembangunan</a></li>
                <li><a class="dropdown-item" href="#praktikum">- Program Praktikum</a></li>
                <li><a class="dropdown-item" href="#lomba">- Program Lomba</a></li>
                <li><a class="dropdown-item" href="#kunjungan">- Kunjungan Industri</a></li>
                <li><a class="dropdown-item" href="#ekstrakurikuler">- Program Ekskul</a></li>
                <li><a class="dropdown-item" href="#kerja_sama">- Program Kerja sama</a></li>
                <li><a class="dropdown-item" href="#magang">- Program Magang</a></li>
              </ul>
            </li>
            <li class="tap_login nav-item dropdown">
              <button class="btn btn-primary nav-link dropdown-toggle" href="#" id="navbarDropdownMenuLink" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                LOGIN
              </button>
              <ul class="dropdown-menu login" aria-labelledby="navbarDropdownMenuLink">
                <li><a class="dropdown-item" href="/guru">Login Sebagai Guru</a></li>
                <li><a class="dropdown-item" href="/siswa">Login Sebagai Siswa</a></li>
              </ul>
            </li>
            <li class="nav-item">
              <a class="click nav-link collapsed" href="#footer">ABOUT</a>
            </li>
          </ul>
        </div>
      </nav>
          ...
          <div class="footer-col">
            <div class="widget no-box">
              <h5 class="widget-title">Contact Us<span></span></h5>
                <p><a href="mailto:info@domain.com" title="glorythemes">SobatBakuHantam@gmail.com</a></p>
